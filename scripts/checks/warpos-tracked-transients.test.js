"use strict";
/**
 * warpos-tracked-transients.test.js — RED proof + known-answer (S-OS-04 / ED-417).
 *
 *   node --test scripts/checks/warpos-tracked-transients.test.js
 *
...
const SCRIPT = path.join(__dirname, "warpos-tracked-transients.js");
const { evaluate, loadAllowlist, TRANSCRIPT_TXT_MIN_BYTES } = require("./warpos-tracked-transients");
